...
public:
    ...
    const std::unordered_set<int> &getIntermediateNegEffsIdx() const { return _intermediate_neg_effs_idx; }
    ...
    void addIntermediatePreconditionIdx(int precondition_idx)
    {
        _intermediate_preconditions_idx.insert(precondition_idx);
    }
